...
import com.e.a5eceviri.ui.races.racedetail.RaceDetailActivity

class RaceAdapter(val list:MutableList<String>): RecyclerView.Adapter<RaceAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.layout.setOnClickListener {
            ...
            var intent = Intent(context, RaceDetailActivity::class.java)
